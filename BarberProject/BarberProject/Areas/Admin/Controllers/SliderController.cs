...
namespace BarberProject.Areas.Admin.Controllers
{
    ...
    public class SliderController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            List<SliderVM> model = datas.Select(m => new SliderVM { Id = m.Id, Title = m.SliderTitle, Description = m.SliderDescription }).ToList();
        ...
        public async Task<IActionResult> Create(SliderCreateVM request)
        {
            ...
            await _sliderService.Create(new Slider { SliderTitle = request.SliderTitle, SliderDescription = request.SliderDesc });
        ...
        public async Task<IActionResult> Edit(int? id, SliderEditVM request)
        {
            ...
            await _sliderService.EditAsync((int)id, new Slider { SliderTitle = request.SliderTitle, SliderDescription = request.SliderDescription });
        ...
        public async Task<IActionResult> Detail(int? id)
        {
            ...
            {
                SliderTitle = existSlider.SliderTitle,
                SliderDesc = existSlider.SliderDescription,
            };
